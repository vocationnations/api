...
func GetMain(w http.ResponseWriter, _ *http.Request, ctx helper.AppContext) error {
...
//func GetOccupations(w http.ResponseWriter, r *http.Request, ctx helper.AppContext) error {
...
//func GetOccupationByCode(w http.ResponseWriter, r *http.Request, ctx helper.AppContext) error {
//	params := mux.Vars(r)
...
//func GetOccupationByTitle(w http.ResponseWriter, r *http.Request, ctx helper.AppContext) error {
//	params := mux.Vars(r)
//	title := params["title"]
//
...
//func GetUserById(w http.ResponseWriter, r *http.Request, ctx helper.AppContext) error {
//	params := mux.Vars(r)
//	id := params["id"]
//
//	var usr model.User
